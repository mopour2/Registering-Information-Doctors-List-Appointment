...
type
  TFormListBimarPezeshk = class(TForm)
    Image1: TImage;
    BitBtn1: TBitBtn;
    DBGrid1: TDBGrid;
...
var
  FormListBimarPezeshk: TFormListBimarPezeshk;
...
procedure TFormListBimarPezeshk.BitBtn1Click(Sender: TObject);
begin
...
DataModule1.ADOQuery4.sql.Add('where TBarnRezerv.CodDateBarn ='+DataModule1.ADOTDateBarnCodDateBarn.AsString+' ');
DataModule1.ADOQuery4.sql.Add('order by TBarnRezerv.Shomare');
//   DataModule1.ADOQuery4.ExecSQL;

 RvProject1.ProjectFile:='ListBPz1.rav';
...
procedure TFormListBimarPezeshk.FormShow(Sender: TObject);
begin
...
procedure TFormListBimarPezeshk.BitBtn2Click(Sender: TObject);
begin
  year:=Ayear;
  month:=Amonth;
  day:=Aday;
...
procedure TFormListBimarPezeshk.BitBtn3Click(Sender: TObject);
begin
  year:=Ayear;
  month:=Amonth;
  day:=Aday;
...
procedure TFormListBimarPezeshk.FormClose(Sender: TObject;
...
procedure TFormListBimarPezeshk.RvSystem1Print(Sender: TObject);
var f:TSaveFont;
begin
